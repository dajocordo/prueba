...
<body>
	<div class="container" style="">
		<div class="row" id="primero">
			<h3 class="centro">Búsqueda de usuarios</h3>
		...
		<div class="row" id="segundo">
			...
			<h2 class="centro">Usuarios</h2><br>
			<p>Para crear un usuario nuevo, dar clic <a href="new">aquí</a></p><br>
			@php if (isset($usuarios) == true) { @endphp
